...
output_dir = "/home/px4_sitl/ets_work/montreal_research/montreal_region_uav_maps_v3.0"
...
# ----------------------------
# Density Classification + UAV Assignment
# ----------------------------
...
# ----------------------------
# Load GeoJSON and Normalize Names
# ----------------------------
...
for _, row in df.iterrows():
    ...
    legend_elements = [
        ...
        Patch(facecolor='white', edgecolor='black', label=f"Area: {area_km2:.2f} km²"),
...
print(f"✅ All regional UAV maps saved to: {output_dir}")
